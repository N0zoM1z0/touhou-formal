...
def main : IO Unit := do
  ...
  IO.println s!"TH08 radius clear: {describeBulletControlOutcome TouhouFormal.Search.BulletControl.th08RadiusOutcome}"
  IO.println s!"TH08 mode-4 clear: {describeBulletControlOutcome TouhouFormal.Search.BulletControl.th08RemoveMode4Outcome}"
  IO.println ""
  ...
  IO.println s!"TH08 death ANM: {describeAnimationOutcome TouhouFormal.Search.Animation.th08DeathOutcome}"
  IO.println ""
  ...
  IO.println ""
  IO.println "Miscellaneous VM and host-state controls"
  IO.println s!"TH06 misc opcode count: {TouhouFormal.Search.Misc.miscOpcodeCount TouhouFormal.TH06.headerShape}"
  IO.println s!"TH07 misc opcode count: {TouhouFormal.Search.Misc.miscOpcodeCount TouhouFormal.TH07.headerShape}"
  IO.println s!"TH08 misc opcode count: {TouhouFormal.Search.Misc.miscOpcodeCount TouhouFormal.TH08.headerShape}"
  IO.println s!"TH07 trail zero-stride fault: {reprStr TouhouFormal.Search.Misc.th07TrailZeroStrideOutcome}"
  IO.println s!"TH08 pause configuration: {reprStr TouhouFormal.Search.Misc.th08SpellPauseOutcome}"
  IO.println s!"TH08 signed clock wrap: {reprStr TouhouFormal.Search.Misc.th08Clock255Outcome}"
  IO.println ""
  IO.println "Cross-enemy boss dispatch controls"
  IO.println s!"TH08 boss-dispatch opcode count: {TouhouFormal.Search.BossDispatch.bossDispatchOpcodeCount TouhouFormal.TH08.headerShape}"
  IO.println s!"TH08 boss CALL stack fault: {reprStr TouhouFormal.Search.BossDispatch.th08CallStackFaultOutcome}"
  IO.println s!"TH08 repeated boss-index fault: {reprStr TouhouFormal.Search.BossDispatch.th08PendingChangedIndexOutcome}"
  IO.println ""
  IO.println "Linked-child controls"
  IO.println s!"TH08 linked-child opcode count: {TouhouFormal.Search.LinkedChild.linkedChildOpcodeCount TouhouFormal.TH08.headerShape}"
  IO.println s!"TH08 nonterminating chain: {reprStr TouhouFormal.Search.LinkedChild.th08DivergingChainOutcome}"
  IO.println s!"TH08 repeated alignment reads: {reprStr TouhouFormal.Search.LinkedChild.th08ScriptPositionOutcome}"
  IO.println s!"TH08 alignment-effect null fault: {reprStr TouhouFormal.Search.LinkedChild.th08AlignmentEffectNullOutcome}"
  IO.println ""
